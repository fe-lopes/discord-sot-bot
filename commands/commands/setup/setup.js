                ...
                if (option === 'add') {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        if (guildData.sot_cookie) {
                            ...
                            try {
                                let requestUrl = sotConfig.request_urls.guild_summary;
                                requestUrl = requestUrl.replace('/{lang}', '');
                                let referer = new URL(sotConfig.headers.referer);
                                referer.pathname += `/${message.content}`;
                                ...
                                const newLocal = 'Ahoy, parece que houve um erro ao buscar informações da guilda.\n';
                                    reply = bold(newLocal);
